...
export default function Search() {
  ...
  return (
    ...
    <div className='bg-[#F1F5F8] pt-[100px] pb-[200px] h-screen'>
        <div className='bg-white mx-auto max-w-[700px] p-[100px]'>

         <h1 className='text-center text-black text-5xl font-bold pb-[60px]'>Grocery List</h1>   
        <input className='bg-[#F1F5F8] rounded-[4px] text-xl w-[500px] py-[6px] px-[15px] mb-[40px] outline-0' type="text" onChange={handleInput} placeholder='Search...........'/>
        {
