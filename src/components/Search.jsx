...
export default function Search() {
  ...
  return (
    ...
    <div className='bg-[#F1F5F8] pt-[100px] pb-[200px] h-screen'>
        <div className='bg-white mx-auto sm:max-w-[600px] md:max-w-[700px] p-10 md:p-[100px]'>

         <h1 className='text-center text-black text-3xl sm:text-4xl p-10 md:text-5xl font-bold pb-[40px] md:pb-[60px]'>Grocery List</h1>   
        <input className='bg-[#F1F5F8] mx-auto block  rounded-[4px] text-xl md:w-[500px] py-[4px] sm:py-[6px] px-[15px] mb-[40px] outline-0' type="text" onChange={handleInput} placeholder='Search...........'/>
        {
